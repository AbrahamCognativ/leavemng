...
def run_accrual_scheduler():
    ...
    scheduler.add_job(
        quarterly_accrual_job,
        'cron',
        month='1,4,7,10',
        day=1,
        hour=0,
        minute=0,
        id='quarterly_accrual_job')
    ...
    def reset_yearly_leave_balances_on_join_date_job():
        ...
        try:
            ...
            db.close()
    scheduler.add_job(
        reset_yearly_leave_balances_on_join_date_job,
        'cron',
        hour=0,
        minute=0,
        id='reset_yearly_leave_balances_on_join_date_job')
    ...
    # Schedule sick leave document check every hour
    scheduler.add_job(
        sick_leave_doc_check_job_scheduler,
        'cron',
        minute=0,
        id='sick_leave_doc_check')
    ...
    def sick_leave_doc_reminder_job_scheduler():
        ...
        try:
            ...
            db.close()
    scheduler.add_job(
        sick_leave_doc_reminder_job_scheduler,
        'cron',
        hour='0,12',
        id='sick_leave_doc_reminder_job')
