...
Revision ID: b39245d01f28
Revises: 41da7e497a2f
Create Date: 2025-05-01 13:11:41.534015
...
revision: str = 'b39245d01f28'
down_revision: Union[str, None] = '41da7e497a2f'
...
def upgrade() -> None:
    ...
    sa.Column('code', sa.Enum('annual', 'sick', 'unpaid', name='leavecodeenum'), nullable=False),
